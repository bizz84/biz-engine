...
void main()
{
	Color.r = exp(-gl_Vertex.w * 0.25);
	Color.g = exp(-gl_Vertex.w * 3.5);
	Color.b = exp(-gl_Vertex.w * 2.5);
	...
	//gl_Position = gl_ModelViewProjectionMatrix * vec4(gl_Vertex.xyz + Position, 1.0);
